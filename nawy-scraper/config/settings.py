...
class Settings(BaseSettings):
    ...
    # MongoDB - Primary SRV connection (European cluster)
    mongo_uri: str = Field(
        default="mongodb+srv://youssifmido2012_db_user:27mapDxxMrTTQKt0@cluster0.hx5zlww.mongodb.net/semsai?retryWrites=true&w=majority&appName=Cluster0",
        env="MONGO_URI"
    )
    ...
    developers_url: str = "https://www.nawy.com/ar/developer"
