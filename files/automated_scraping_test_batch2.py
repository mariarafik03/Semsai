"""
SEMSAI AUTOMATED SCRAPING TEST SUITE — v4.1 BATCH 2
====================================================
20 NEW test cases — completely different from Batch 1.

Batch 1 covered: Palm Hills, Zed East, Madinaty, Hyde Park, Mivida,
  Sodic East, IL Monte Galala, Badya, Villette, Hacienda Bay, Fouka Bay,
  Marassi, Katameya Heights, Al Burouj.

Batch 2 covers: Mountain View, New Cairo compounds, Heliopolis area,
  Sheikh Zayed, New Capital, Ain Sokhna new compounds, different
  unit sizes, penthouses, studios, ultra-luxury, and niche areas.
"""
...
TEST_CASES = [
    ...
    # ── NEW CAIRO: different compounds ────────────────────────
    {"id":"B1",
     "label":"Apartment resale — Mountain View (iCity, New Cairo)",
     "area":145,"bedrooms":3,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Resale",
     "compound":"Mountain View iCity","location":"New Cairo",
     "developer":"Mountain View"},

    {"id":"B2",
     "label":"Apartment dev sale — Sarai (New Cairo, Mnhd)",
     "area":135,"bedrooms":2,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Developer Sale",
     "compound":"Sarai","location":"New Cairo",
     "developer":"Mnhd"},

    {"id":"B3",
     "label":"Apartment resale — Stone Park (New Cairo)",
     "area":155,"bedrooms":3,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Resale",
     "compound":"Stone Park","location":"New Cairo",
     "developer":"Roya Developments"},

    {"id":"B4",
     "label":"Apartment dev sale — Scenario (Obour, affordable)",
     "area":100,"bedrooms":2,"bathrooms":1,
     "property_type":"Apartment","sale_type":"Developer Sale",
     "compound":"Scenario","location":"New Cairo",
     "developer":"Hap Town"},

    {"id":"B5",
     "label":"Apartment resale — Midtown (New Cairo, Better Home)",
     "area":175,"bedrooms":3,"bathrooms":3,
     "property_type":"Apartment","sale_type":"Resale",
     "compound":"Midtown East","location":"New Cairo",
     "developer":"Better Home"},

    # ── 6TH OCTOBER / SHEIKH ZAYED ────────────────────────────
    {"id":"B6",
     "label":"Apartment resale — Westown (Sheikh Zayed, Sodic)",
     "area":160,"bedrooms":3,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Resale",
     "compound":"Westown","location":"Sheikh Zayed",
     "developer":"Sodic"},

    {"id":"B7",
     "label":"Villa dev sale — Allegria (Sheikh Zayed, Sodic)",
     "area":320,"bedrooms":4,"bathrooms":3,
     "property_type":"Villa","sale_type":"Developer Sale",
     "compound":"Allegria","location":"Sheikh Zayed",
     "developer":"Sodic"},

    {"id":"B8",
     "label":"Apartment resale — Keeva (6th Oct, Tatweer Misr)",
     "area":115,"bedrooms":2,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Resale",
     "compound":"Keeva","location":"6th of October",
     "developer":"Tatweer Misr"},

    # ── NEW CAPITAL ───────────────────────────────────────────
    {"id":"B9",
     "label":"Apartment dev sale — Midtown Condo (New Capital)",
     "area":105,"bedrooms":2,"bathrooms":1,
     "property_type":"Apartment","sale_type":"Developer Sale",
     "compound":"Midtown Condo","location":"New Capital",
     "developer":"Better Home"},

    {"id":"B10",
     "label":"Apartment dev sale — City Oval (New Capital)",
     "area":120,"bedrooms":2,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Developer Sale",
     "compound":"City Oval","location":"New Capital",
     "developer":"City Edge"},

    # ── VILLAS: new compounds ─────────────────────────────────
    {"id":"B11",
     "label":"Villa resale — Mountain View 1 (5th Settlement)",
     "area":280,"bedrooms":4,"bathrooms":3,
     "property_type":"Villa","sale_type":"Resale",
     "compound":"Mountain View 1","location":"New Cairo",
     "developer":"Mountain View"},

    {"id":"B12",
     "label":"Villa dev sale — Zed (Sheikh Zayed, ORA)",
     "area":350,"bedrooms":4,"bathrooms":4,
     "property_type":"Villa","sale_type":"Developer Sale",
     "compound":"Zed","location":"Sheikh Zayed",
     "developer":"ORA"},

    {"id":"B13",
     "label":"Villa resale — Lake View (New Cairo, Raya)",
     "area":250,"bedrooms":3,"bathrooms":3,
     "property_type":"Villa","sale_type":"Resale",
     "compound":"Lake View","location":"New Cairo",
     "developer":"Raya Developments"},

    # ── NORTH COAST: new compounds ────────────────────────────
    {"id":"B14",
     "label":"Chalet dev sale — Amwaj (North Coast, Tatweer)",
     "area":110,"bedrooms":2,"bathrooms":2,
     "property_type":"Chalet","sale_type":"Developer Sale",
     "compound":"Amwaj","location":"North Coast",
     "developer":"Tatweer Misr"},

    {"id":"B15",
     "label":"Chalet resale — Diplo (North Coast)",
     "area":95,"bedrooms":2,"bathrooms":1,
     "property_type":"Chalet","sale_type":"Resale",
     "compound":"Diplo","location":"North Coast",
     "developer":"City Edge"},

    {"id":"B16",
     "label":"Chalet dev sale — Cleopatra (North Coast, Palm Hills)",
     "area":130,"bedrooms":3,"bathrooms":2,
     "property_type":"Chalet","sale_type":"Developer Sale",
     "compound":"Cleopatra Beach","location":"North Coast",
     "developer":"Palm Hills Developments"},

    # ── AIN SOKHNA: new compounds ─────────────────────────────
    {"id":"B17",
     "label":"Chalet resale — Porto Sokhna (Ain Sokhna)",
     "area":85,"bedrooms":2,"bathrooms":1,
     "property_type":"Chalet","sale_type":"Resale",
     "compound":"Porto Sokhna","location":"Ain Sokhna",
     "developer":"Amer Group"},

    # ── EDGE CASES: new scenarios ─────────────────────────────
    {"id":"B18",
     "label":"EDGE: Studio apartment (tiny, 50sqm)",
     "area":50,"bedrooms":1,"bathrooms":1,
     "property_type":"Apartment","sale_type":"Developer Sale",
     "compound":"Zed East","location":"New Cairo",
     "developer":"ORA"},

    {"id":"B19",
     "label":"EDGE: Large penthouse (250sqm, New Cairo)",
     "area":250,"bedrooms":4,"bathrooms":3,
     "property_type":"Apartment","sale_type":"Resale",
     "compound":"Mivida","location":"New Cairo",
     "developer":"Emaar Misr"},

    {"id":"B20",
     "label":"EDGE: New developer (Dorra, 6th Oct)",
     "area":130,"bedrooms":2,"bathrooms":2,
     "property_type":"Apartment","sale_type":"Developer Sale",
     "compound":"Dorra Greens","location":"6th of October",
     "developer":"Dorra Developments"},
]

# ── All functions copied from v4 (identical logic) ────────────
...
def run_single_test(f):
    ...
    try:
        ...
        if clean:
            # FIX 9: median not mean
            med=statistics.median(clean)
            result["web_median"]=round(med); result["web_ppm"]=round(med/f["area"])
            result["status"]="success"
            cf=" [LC]" if lc else ""; fb=" FB" if fallback_used else ""
            print(f"\n  {'⚠️ FALLBACK' if fallback_used else '✅ COMPOUND'}{cf}{fb}  median={med:,.0f} ({med/f['area']:,.0f}/sqm) n={len(clean)}")
        else:
...
def print_report(results):
    ...
    print("\n\n"+"★"*60)
    print("  SEMSAI BATCH 2 TEST SUITE — FINAL REPORT")
    print("★"*60)
    ...
    # Market band check
    BANDS = {
        "B1": (70000,140000), "B2": (70000,130000), "B3": (70000,130000),
        "B4": (40000,90000),  "B5": (70000,130000), "B6": (80000,140000),
        "B7": (80000,160000), "B8": (55000,110000), "B9": (50000,100000),
        "B10":(50000,100000), "B11":(80000,160000), "B12":(80000,160000),
        "B13":(70000,140000), "B14":(80000,160000), "B15":(70000,150000),
        "B16":(90000,170000), "B17":(60000,130000), "B18":(80000,160000),
        "B19":(100000,170000),"B20":(50000,110000),
    }
    in_band = sum(1 for r in results if r["status"]=="success" and
                  BANDS.get(r["id"],[0,999999])[0] <= r["web_ppm"] <= BANDS.get(r["id"],[0,999999])[1])

    print(f"  In market band: {in_band}/{success} successful")

    print(f"\n  {'─'*56}")
    print(f"  {'ID':4}  {'Compound':22}  {'Type':9}  {'ppm':>10}  n   Status")
    print(f"  {'─'*56}")
    for r in results:
        icon="✅" if r["status"]=="success" else "❌"
        lc_f=" [LC]" if r["low_confidence"] else ""
        fb_f=" FB" if r["fallback_used"] else ""
        lo,hi = BANDS.get(r["id"],[0,999999])
        band = "" if r["status"]!="success" else (" ✓" if lo<=r["web_ppm"]<=hi else " ⚠band")
        print(f"  {icon} {r['id']:4}  {r['compound']:22}  {r['property_type']:9}  {r['web_ppm']:>10,}  {len(r['clean_prices']):<3} {r['status']}{lc_f}{fb_f}{band}")

    grade = "A" if success==total else "B" if success>=total*0.85 else "C"
    print(f"\n  Grade: {grade}")
    print("★"*60)

def run_all_tests():
    print("★"*60)
    print(f"  SEMSAI BATCH 2 — {len(TEST_CASES)} NEW TEST CASES")
    print(f"  v4.1 (median) | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("★"*60)
    ...
    with open("scraping_report_batch2.json","w",encoding="utf-8") as f:
        json.dump(report,f,ensure_ascii=False,indent=2)
    print("\n  📄 Saved → scraping_report_batch2.json")
    print("  → Paste here for full analysis.\n")
    return report
